      ...
      <View className="bg-[#F3F4EE] min-h-screen">
        ...
        >
          <View className="flex items-center">
            <View
              className="text-sm rounded-full w-16 pl-1"
              style={{
          ...
          <View>
              ...
              <SwipeCell>
                <Cell>
                  <View className="flex w-full py-2">
                    <Avatar
                      src={historyOrderInfo.courierInfo.avatar}
                      size="large"
                    />
                    <View className="ml-3 flex-1">
                      <View className="flex justify-between">
                        <Text className="font-medium">
                          {historyOrderInfo.courierInfo.name}
                        </Text>
                        <View className="flex items-center">
                          <StarOutlined className="text-yellow-500 mr-1" />
                          <Text className="text-yellow-500">
                            {historyOrderInfo.courierInfo.rating}
                          </Text>
                        </View>
                      </View>
                      <Text className="text-sm text-gray-500 mt-1">
                        {historyOrderInfo.courierInfo.phone}
                      </Text>
            ...
            <View className="mx-4 mt-4 bg-[#FEFFFB] rounded-sm overflow-hidden">
              <Cell.Group>
                ...
                <Cell title="取件码">
                  <View className="font-medium text-lg">
                    {historyOrderInfo.expressid}
                  </View>
                </Cell>
              ...
              <View className="p-4">
                ...
                <View className="flex justify-between mb-2">
                  ...
                  <Text className="text-green-500">
                    {historyOrderInfo.payment.status}
                  </Text>
                </View>
                <Divider />
                <View className="flex justify-between items-center">
                  ...
                  <Text className="text-xl font-bold">
                    ¥{historyOrderInfo.payment.amount}
                  </Text>
                </View>
              </View>
            </View>
